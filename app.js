...
const wokeisms = [
 ...
 `The knowledge principle underlying postmodernism is radical skepticis about whether objective knowledge or truth is obtainable and a commitment to cultural constructivism.`, 
 ...
 `Research justice is the demand that scholars preferrentially cite women and minorities while minimizing citations from white men because empirical research that values knowledge production rooted in evidence and reasoned argument is an unfairly privileged culutural construct of white Westerners. It is therefore a moral obligation to share the prestige of rigorous research with "other forms of knowing/reasearch", including: superstition, spiritual beliefs, cultural traditions and beliefs, identity-based experiences, and emotional responses.`, 
 ...
 `Being on time is an assumption of Whiteness.`, 
 `Mathematics is racist.`, 
 `The Scientific Method is a form of cultural oppression.`, 
 `The nuclear family is a form of cultural oppression.`, 
 ...
 `"I have found it useful here to employ Michel Foucault's notion of a discourse, as described by him in The Archeaology of Knowledge and in Discipline and PUnish, to identify Orientalism. My contention is that wihtout examining Orientalism as a discourse one cannot possibly understand the enormously systematic discipline by which European culture was able to manage -- and even produce -- the Orient politically, sociologically, ideologically, scientifically, and imaginatively during the post-Enlightenment period."`, 
 ...
 `"I find Derrida's morphology much more painstaking and useful than Foucault's and Deleuze's immediate, substantive invovlement with more "political" issues -- the latter's invitation to "become woman"--which can ake their influence more dangerous for the U.S. academic as enthusiastic radical. Derrida marks radical critique with the danger of appropriating the other by assimiliation. He reads catachresis at the origin. He calls for a rewriting of the utopian structural impulse as "rendering delierious that interior voice that is the voice of the other in us."`, 
 `"If, for a while, the ruse of desire is calculable for the use of discipline, soon the repetition of guilt, justification, pseudo-scientific theories, superstition, spurious authorities, and classifications can be seen as the desperate effor to "normalize" formally the disturbance of a discourse of splitting that violates the rational, enlightened claims of its enunciatory modality."`, 
 ...
 `Black people cannot be racist because racism equals prejudice plus power.`, 
...
`In the 2004 book, Decolonizing Research in Cross-Cultural Contexts: Critical Personal Narratives, the editors introduce the essays by claiming, "These works stand at the center of the "beginning of the presencing" of a disharmonious, restive, unharnessable (hence unesstializable) knowledge that is produced at the ex-centric site of neo/post/colonial resistance, "which can nevera llow the national (read: colonial/western) history to look itself narcisstically in the eye." That is to say, the editors are claiming that they are not obliged to make sense, produce reasoned arguments, avoid logical contradiction, or provide any research for their claims. The normal expectations of scholarly research do not apply when pursuing research justice.`,
