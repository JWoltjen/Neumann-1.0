...
const wokeisms = [
 ...
 `Postmodernists are skeptical of universal truth. They claim that, "We need to make a distinction between the claim that the world is out there and the claim that the truth is out there."`, 
 ...
 `The consequence of the second wave of postmodernism is to blur the boundaries between the academy and activism. It shifted from a discipline which attempted to describe an "is" into a religion which attempts to prescribe an "ought".`, 
 ...
 `Post-colonial theorists observe that, "It will be difficult to contest the idea that, generally speaking, philosophy as a field or a discipline in modern Western universities remains a bastion of Eurocentrism, whiteness in general, and white heteronormative male structural privilege and superiority in particular."`, 
...
`"It is not simply that queer has yet to solidify and take on a more consistent profile, but rather, that its definitional indeterminacy, its elasticity, is one of its constituent characteristics."`, 
...
`"Scientific discourse set itself up as the supreme authority in matters of hygienic necessity and in the name of biological and historical urgency, it justified the racisms of the state because it grounded them in the 'truth'". That's right, the Scientific Method is a rascist form of cultural oppression.`, 
...
`Intersectional feminists claim that "Gender is entirely a social construction which is performative and has absolutely no biological basis."`, 
`Intersectional feminists claim that "Sex is that reiterative power of discourse to produce the phenomena that it regulates and constrains"`, 
...
`Intersectional feminists claim that "If the immutable character of sex is contested, perhaps this construct called "sex" is as culturally constructed as gender; indeed, perhaps it was always already gender, with the consequence that the distinction between sex and gender turns out to be no distinction at all."`, 
...
`Helen Pluckrose and James Lindsey observe that "It is bad psychology to tell people who do not believe they are racist--who may even actively despise racism--that there is nothing they can do to stop themselves from being racist--and then ask those very same people to help you and embrace your ideology."`, 
...
`Intersectional critical race theorests claim that "The concept of racial privilege attempts to strategically define the absence of discrimination and disenfranchisement as unjust and problematic."`, 
`The ascendance of wokeism and its psychological necessity, as well as its underlying moral assumptions and foundations were all accurately predicted by Friedrich Nietzsche's seminal work, "On the Genealogy of Morality", which he wrote in 1887. To grossly oversimplify everything into a single sentence, "The sheep hates the bird because the bird is better."`,
`The ascendance of wokeism and its psychological necessity, as well as its underlying moral assumptions and foundations were all accurately predicted by Friedrich Nietzsche's seminal work, "On the Genealogy of Morality", which he wrote in 1887. To grossly oversimplify everything into a single sentence, "Weak people created the religion of Wokeism, with its own set of sacraments and orthodoxy, in order to cope with the feelings of powerlessness and uselessness they feel in every day life." But remember, our enemies, even the enemies of truth, wisdom, and knowledge, are not demons, but people like us.`,
`The ascendance of wokeism and its psychological necessity, as well as its underlying moral assumptions and foundations were all accurately predicted by Friedrich Nietzsche's seminal work, "On the Genealogy of Morality", which he wrote in 1887. To grossly oversimplify everything into a single sentence, "Ressentiment is a sense of hostility directed toward an object that one identifies as the cause of one's frustration -- that is, an assignment of blame on the other for one's frustration or feelings of weakness. Does this sound familiar?"`,
`The favorite tools of the acolytes of wokeism are: nitpicking at words to deliberately miss the point, which they call close reading or deconstruction, social media bullying, concern trolling, altruistic punishment, cancelling, catastrophizing everyday social interactions, peacocking faux moral superiority, victimology-based performance art, black and white thinking, intellectual hostage taking, and when all else fails, simply yelling and screaming.`,
`The favorite tools of the acolytes of wokeism are: nitpicking at words to deliberately miss the point, which they call close reading or deconstruction, social media bullying, concern trolling, altruistic punishment, cancelling, catastrophizing everyday social interactions, peacocking faux moral superiority, victimology-based performance art, black and white thinking, intellectual hostage taking, and when all else fails, simply yelling and screaming.`,
`The favorite tools of the acolytes of wokeism are: nitpicking at words to deliberately miss the point, which they call close reading or deconstruction, social media bullying, concern trolling, altruistic punishment, cancelling, catastrophizing everyday social interactions, peacocking faux moral superiority, victimology-based performance art, black and white thinking, intellectual hostage taking, and when all else fails, simply yelling and screaming.`,
`The favorite tools of the acolytes of wokeism are: nitpicking at words to deliberately miss the point, which they call close reading or deconstruction, social media bullying, concern trolling, altruistic punishment, cancelling, catastrophizing everyday social interactions, peacocking faux moral superiority, victimology-based performance art, black and white thinking, intellectual hostage taking, and when all else fails, simply yelling and screaming.`,
]
